...
public class MybatisPlusUtils {
    ...
    public static void main(String[] args) {
        String[] models = {"ssm-impl","ssm-model","ssm-service","ssm-web"};
    ...
    private static void shell(String model){
        ...
        pc.setEntity("entity");
        pc.setMapper("com/example/project/mapper/impl");
        pc.setService("service");
        pc.setServiceImpl("com/example/project/mapper/impl");
